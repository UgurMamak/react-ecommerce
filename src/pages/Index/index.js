        ...
        return (
            <div className="ps-main">
                ...
                <div className="ps-section--offer">
                    <div className="ps-column"><a className="ps-offer" href="product-listing.html"><img src="skytheme-ecommerce-html5-template/template/images/banner/home-banner-1.png" alt="" /></a></div>
                    <div className="ps-column"><a className="ps-offer" href="product-listing.html"><img src="skytheme-ecommerce-html5-template/template/images/banner/home-banner-2.png" alt="" /></a></div>
                </div>
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                                    <div className="ps-hot-deal">
                                        ...
                                        <ul className="ps-countdown" data-time="December 13, 2017 15:37:25">
                                            <li><span className="hours" /><p>Hours</p></li>
                                            <li className="divider">:</li>
                                            <li><span className="minutes" /><p>minutes</p></li>
                                            <li className="divider">:</li>
                                            <li><span className="seconds" /><p>Seconds</p></li>
                                        </ul><a className="ps-btn" href="#">Order Today<i className="ps-icon-next" /></a>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                                    <div className="ps-hotspot"><a className="point first active" href="#"><i className="fa fa-plus" />
                                        ...
                                        </div></a><a className="point second" href="#"><i className="fa fa-plus" />
                                        <div className="ps-hotspot__content">
                                            <p className="heading">JUMP TO HEADER</p>
                                            <p>Dynamic Fit Collar en la zona del tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad de movimiento.</p>
                                        </div></a><a className="point third" href="#"><i className="fa fa-plus" />
                                        <div className="ps-hotspot__content">
                                            <p className="heading">JUMP TO HEADER</p>
                                            <p>Dynamic Fit Collar en la zona del tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad de movimiento.</p>
                                        </div></a><img src="skytheme-ecommerce-html5-template/template/images/hot-deal.png" alt="" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed={5000} data-owl-gap={0} data-owl-nav="false" data-owl-dots="true" data-owl-item={1} data-owl-item-xs={1} data-owl-item-sm={1} data-owl-item-md={1} data-owl-item-lg={1} data-owl-duration={1000} data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
                            <div className="ps-testimonial">
                                <div className="ps-testimonial__thumbnail"><img src="skytheme-ecommerce-html5-template/template/images/testimonial/1.jpg" alt="" /><i className="fa fa-quote-left" /></div>
                                <header>
                            ...
                            <div className="ps-testimonial">
                                <div className="ps-testimonial__thumbnail"><img src="skytheme-ecommerce-html5-template/template/images/testimonial/2.jpg" alt="" /><i className="fa fa-quote-left" /></div>
                                <header>
                                    <select className="ps-rating">
                                        <option value={1}>1</option>
                                        <option value={1}>2</option>
                            ...
                            <div className="ps-testimonial">
                                <div className="ps-testimonial__thumbnail"><img src="skytheme-ecommerce-html5-template/template/images/testimonial/3.jpg" alt="" /><i className="fa fa-quote-left" /></div>
                                <header>
                                    <select className="ps-rating">
                                        <option value={1}>1</option>
                                        <option value={1}>2</option>
                ...
                <div className="ps-section ps-home-blog pt-80 pb-80">
                    <div className="ps-container">
                        <div className="ps-section__header mb-50">
                            ...
                            <div className="ps-section__action"><a className="ps-morelink text-uppercase" href="#">View all post<i className="fa fa-long-arrow-right" /></a></div>
                        </div>
                        <div className="ps-section__content">
                            <div className="row">
