                                    ...
                                    <div className="header__actions"><a href="#">Login &amp; Regiser</a>
                                        <div className="btn-group ps-dropdown"><a className="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD<i className="fa fa-angle-down" /></a>
                                            <ul className="dropdown-menu">
                                                <li><a href="#"><img src="skytheme-ecommerce-html5-template/template/images/flag/usa.svg" alt="" /> USD</a></li>
                                                <li><a href="#"><img src="skytheme-ecommerce-html5-template/template/images/flag/singapore.svg" alt="" /> SGD</a></li>
                                                <li><a href="#"><img src="skytheme-ecommerce-html5-template/template/images/flag/japan.svg" alt="" /> JPN</a></li>
                                            </ul>
                                        </div>
                    ...
                    <nav className="navigation">
                        <div className="container-fluid">
                            <div className="navigation__column left">
                                <div className="header__logo"><a className="ps-logo" href="index.html"><img src="skytheme-ecommerce-html5-template/template/images/logo.png" alt="" /></a></div>
                            </div>
