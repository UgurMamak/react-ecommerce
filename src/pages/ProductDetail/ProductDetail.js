              ...
              <div className="col-lg-10 col-md-12 col-lg-offset-1">
                <div className="ps-product__thumbnail">
                  <div className="ps-product__preview">
                    <div className="ps-product__variants">
                      <div className="item">
                        <img
                          src="skytheme-ecommerce-html5-template/template/images/shoe-detail/1.jpg"
                          alt=""
                        />
                      </div>
                      <div className="item">
                        <img
                          src="skytheme-ecommerce-html5-template/template/images/shoe-detail/2.jpg"
                          alt=""
                        />
                      </div>
                      <div className="item">
                        <img
                          src="skytheme-ecommerce-html5-template/template/images/shoe-detail/3.jpg"
                          alt=""
                        />
                      </div>
                      <div className="item">
                ...
                <div className="ps-product__info">
                  ...
                  <div className="ps-product__block ps-product__quickview">
                    <h4>QUICK REVIEW</h4>
                    <p>
                      The Nike Free RN 2017 Mens Running Sky weighs less than
                  ...
                  <div className="ps-product__block ps-product__style">
                    ...
                    <ul>
                      <li>
                        <a aria-label="''" href="product-detail.html">
                          <img
                            src="skytheme-ecommerce-html5-template/template/images/shoe/sidebar/1.jpg"
                            alt=""
                          />
                        </a>
                      </li>
                      <li>
                        <a aria-label="''" href="product-detail.html">
                          <img
                            src="skytheme-ecommerce-html5-template/template/images/shoe/sidebar/2.jpg"
                            alt=""
                          />
                        </a>
                      </li>
                      <li>
                        <a aria-label="''" href="product-detail.html">
                          <img
                            src="skytheme-ecommerce-html5-template/template/images/shoe/sidebar/3.jpg"
                            alt=""
                          />
                        </a>
                      </li>
                  ...
                  <div className="ps-product__shopping">
                    ...
                    <div className="ps-product__actions">
                      ...
                      <a aria-label="''" href="compare.html">
                  ...
                  <div className="tab-pane" role="tabpanel" id="tab_02">
                    ...
                    <div className="ps-review">
                      <div className="ps-review__thumbnail">
                        <img
                          src="skytheme-ecommerce-html5-template/template/images/user/1.jpg"
                          alt=""
                        />
                      </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                  <div className="ps-owl-actions">
                    <a aria-label="''" className="ps-prev" href="#">
                      <i className="ps-icon-arrow-right" />
                      Prev
                    </a>
                    <a aria-label="''" className="ps-next" href="#">
                      Next
                ...
                <div className="ps-shoes--carousel">
                  <div className="ps-shoe">
                    <div className="ps-shoe__thumbnail">
                      ...
                      <a aria-label="''" className="ps-shoe__favorite" href="#">
                        <i className="ps-icon-heart" />
                      </a>
                      <img
                        src="skytheme-ecommerce-html5-template/template/images/shoe/1.jpg"
                        alt=""
                      />
                      <a
                        aria-label="''"
                    ...
                    <div className="ps-shoe__content">
                      <div className="ps-shoe__variants">
                        <div className="ps-shoe__variant normal">
                          <img
                            src="skytheme-ecommerce-html5-template/template/images/shoe/2.jpg"
                            alt=""
                          />
                          <img
                            src="skytheme-ecommerce-html5-template/template/images/shoe/3.jpg"
                            alt=""
                          />
                          <img
                            src="skytheme-ecommerce-html5-template/template/images/shoe/4.jpg"
                            alt=""
                          />
                          <img
                            src="skytheme-ecommerce-html5-template/template/images/shoe/5.jpg"
                            alt=""
                          />
                        </div>
                ...
                <div className="ps-shoes--carousel">
                  <div className="ps-shoe">
                    <div className="ps-shoe__thumbnail">
                      ...
                      <img
                        src="skytheme-ecommerce-html5-template/template/images/shoe/6.jpg"
                        alt=""
                      />
                      <a
                        aria-label="''"
