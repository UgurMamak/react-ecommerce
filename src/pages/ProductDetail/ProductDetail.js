                            ...
                            <div className="col-lg-10 col-md-12 col-lg-offset-1">
                                <div className="ps-product__thumbnail">
                                    <div className="ps-product__preview">
                                        <div className="ps-product__variants">
                                            <div className="item"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/1.jpg" alt="" /></div>
                                            <div className="item"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/2.jpg" alt="" /></div>
                                            <div className="item"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/3.jpg" alt="" /></div>
                                            <div className="item"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/3.jpg" alt="" /></div>
                                            <div className="item"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/3.jpg" alt="" /></div>
                                        </div><a className="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/1.jpg" alt="" /><i className="fa fa-play" /></a>
                                    </div>
                                    <div className="ps-product__image">
                                        <div className="item"><img className="zoom" src="skytheme-ecommerce-html5-template/template/images/shoe-detail/1.jpg" alt="" data-zoom-image="images/shoe-detail/1.jpg" /></div>
                                        <div className="item"><img className="zoom" src="skytheme-ecommerce-html5-template/template/images/shoe-detail/2.jpg" alt="" data-zoom-image="images/shoe-detail/2.jpg" /></div>
                                        <div className="item"><img className="zoom" src="skytheme-ecommerce-html5-template/template/images/shoe-detail/3.jpg" alt="" data-zoom-image="images/shoe-detail/3.jpg" /></div>
                                    </div>
                                </div>
                                <div className="ps-product__thumbnail--mobile">
                                    <div className="ps-product__main-img"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/1.jpg" alt="" /></div>
                                    <div className="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed={5000} data-owl-gap={20} data-owl-nav="true" data-owl-dots="false" data-owl-item={3} data-owl-item-xs={3} data-owl-item-sm={3} data-owl-item-md={3} data-owl-item-lg={3} data-owl-duration={1000} data-owl-mousedrag="on"><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/1.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/2.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe-detail/3.jpg" alt="" /></div>
                                </div>
                                <div className="ps-product__info">
                                    ...
                                    <div className="ps-product__block ps-product__style">
                                        ...
                                        <ul>
                                            <li><a href="product-detail.html"><img src="skytheme-ecommerce-html5-template/template/images/shoe/sidebar/1.jpg" alt="" /></a></li>
                                            <li><a href="product-detail.html"><img src="skytheme-ecommerce-html5-template/template/images/shoe/sidebar/2.jpg" alt="" /></a></li>
                                            <li><a href="product-detail.html"><img src="skytheme-ecommerce-html5-template/template/images/shoe/sidebar/3.jpg" alt="" /></a></li>
                                            <li><a href="product-detail.html"><img src="skytheme-ecommerce-html5-template/template/images/shoe/sidebar/2.jpg" alt="" /></a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="ps-product__shopping"><a className="ps-btn mb-10" href="cart.html">Add to cart<i className="ps-icon-next" /></a>
                                        <div className="ps-product__actions"><a className="mr-10" href="whishlist.html"><i className="ps-icon-heart" /></a><a href="compare.html"><i className="ps-icon-share" /></a></div>
                                    </div>
                                </div>
                                ...
                                <div className="tab-content mb-60">
                                    ...
                                    <div className="tab-pane" role="tabpanel" id="tab_02">
                                        ...
                                        <div className="ps-review">
                                            <div className="ps-review__thumbnail"><img src="skytheme-ecommerce-html5-template/template/images/user/1.jpg" alt="" /></div>
                                    ...
                                    <div className="tab-pane" role="tabpanel" id="tab_04">
                                        <div className="form-group">
                                            <textarea className="form-control" rows={6} placeholder="Enter your addition here..." defaultValue={""} />
                                        </div>
                                        <div className="form-group">
                        ...
                        <div className="ps-section__content">
                                ...
                                <div className="ps-shoes--carousel">
                                    <div className="ps-shoe">
                                        <div className="ps-shoe__thumbnail">
                                            <div className="ps-badge"><span>New</span></div><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart" /></a><img src="skytheme-ecommerce-html5-template/template/images/shoe/1.jpg" alt="" /><a className="ps-shoe__overlay" href="product-detail.html" />
                                        </div>
                                ...
                                <div className="ps-shoes--carousel">
                                    <div className="ps-shoe">
                                        <div className="ps-shoe__thumbnail">
                                            ...
                                            <div className="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart" /></a><img src="skytheme-ecommerce-html5-template/template/images/shoe/2.jpg" alt="" /><a className="ps-shoe__overlay" href="product-detail.html" />
                                        </div>
                                        <div className="ps-shoe__content">
                                            <div className="ps-shoe__variants">
                                                <div className="ps-shoe__variant normal"><img src="skytheme-ecommerce-html5-template/template/images/shoe/2.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/3.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/4.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/5.jpg" alt="" /></div>
                          ...
                          <del>£220</del> £ 120</span>
                                ...
                                <div className="ps-shoes--carousel">
                                    <div className="ps-shoe">
                                        <div className="ps-shoe__thumbnail">
                                            <div className="ps-badge"><span>New</span></div><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart" /></a><img src="skytheme-ecommerce-html5-template/template/images/shoe/3.jpg" alt="" /><a className="ps-shoe__overlay" href="product-detail.html" />
                                        </div>
                                        <div className="ps-shoe__content">
                                            <div className="ps-shoe__variants">
                                                <div className="ps-shoe__variant normal"><img src="skytheme-ecommerce-html5-template/template/images/shoe/2.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/3.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/4.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/5.jpg" alt="" /></div>
                                ...
                                <div className="ps-shoes--carousel">
                                    <div className="ps-shoe">
                                        <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart" /></a><img src="skytheme-ecommerce-html5-template/template/images/shoe/4.jpg" alt="" /><a className="ps-shoe__overlay" href="product-detail.html" />
                                        </div>
                                        <div className="ps-shoe__content">
                                            <div className="ps-shoe__variants">
                                                <div className="ps-shoe__variant normal"><img src="skytheme-ecommerce-html5-template/template/images/shoe/2.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/3.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/4.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/5.jpg" alt="" /></div>
                                ...
                                <div className="ps-shoes--carousel">
                                    <div className="ps-shoe">
                                        <div className="ps-shoe__thumbnail">
                                            <div className="ps-badge"><span>New</span></div><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart" /></a><img src="skytheme-ecommerce-html5-template/template/images/shoe/5.jpg" alt="" /><a className="ps-shoe__overlay" href="product-detail.html" />
                                        </div>
                                        <div className="ps-shoe__content">
                                            <div className="ps-shoe__variants">
                                                <div className="ps-shoe__variant normal"><img src="skytheme-ecommerce-html5-template/template/images/shoe/2.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/3.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/4.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/5.jpg" alt="" /></div>
                                ...
                                <div className="ps-shoes--carousel">
                                    <div className="ps-shoe">
                                        <div className="ps-shoe__thumbnail"><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart" /></a><img src="skytheme-ecommerce-html5-template/template/images/shoe/6.jpg" alt="" /><a className="ps-shoe__overlay" href="product-detail.html" />
                                        </div>
                                        <div className="ps-shoe__content">
                                            <div className="ps-shoe__variants">
                                                <div className="ps-shoe__variant normal"><img src="skytheme-ecommerce-html5-template/template/images/shoe/2.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/3.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/4.jpg" alt="" /><img src="skytheme-ecommerce-html5-template/template/images/shoe/5.jpg" alt="" /></div>
