          ...
          <div className="ps-cart__content">
            <div className="ps-cart-item">
              ...
              <div className="ps-cart-item__thumbnail">
                ...
                <img
                  src="skytheme-ecommerce-html5-template/template/images/cart-preview/1.jpg"
                  alt=""
                />
              </div>
              <div className="ps-cart-item__content">
                <a className="ps-cart-item__title" href="product-detail.html">
                  Amazin’ Glazin’
                </a>
                <p>
                  <span>
            ...
            <div className="ps-cart-item">
              ...
              <div className="ps-cart-item__thumbnail">
                <a href="product-detail.html" aria-label="''" />
                <img
                  src="skytheme-ecommerce-html5-template/template/images/cart-preview/2.jpg"
                  alt=""
                />
              </div>
              <div className="ps-cart-item__content">
