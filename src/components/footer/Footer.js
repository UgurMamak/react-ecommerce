                  ...
                  <aside className="ps-widget--footer ps-widget--info">
                    <header>
                      <a className="ps-logo" href="index.html">
                        <img
                          src="skytheme-ecommerce-html5-template/template/images/logo-white.png"
                          alt=""
                        />
                      </a>
                  ...
                  <aside className="ps-widget--footer ps-widget--link">
                    ...
                    <footer>
                      <ul className="ps-list--link">
                        <li>
                          <a href="index.html">Coupon Code</a>
                        </li>
                        <li>
                          <a href="index.html">SignUp For Email</a>
                        </li>
                        <li>
                          <a href="index.html">Site Feedback</a>
                        </li>
                        <li>
                  ...
                  <aside className="ps-widget--footer ps-widget--link">
                    ...
                    <footer>
                      <ul className="ps-list--line">
                        ...
                        <li>
                          <a href="index.html">Shipping and Delivery</a>
                        </li>
                        <li>
                  ...
                  <aside className="ps-widget--footer ps-widget--link">
                    ...
                    <footer>
                      <ul className="ps-list--line">
                        ...
                        <li>
                          <a href="index.html">Accessries</a>
                        </li>
                        <li>
                          <a href="index.html">Football Boots</a>
                        </li>
                      </ul>
                    </footer>
                  </aside>
            ...
            <div className="ps-container">
              <div className="row">
                <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                  <p>
                    © <a href="index.html">SKYTHEMES</a>, Inc. All rights
                    Resevered. Design by <a href="index.html"> Alena Studio</a>
                  </p>
                </div>
                <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
