      ...
      <ul className="main-menu menu">
        <li className="menu-item menu-item-has-children dropdown">
          ...
          <ul className="sub-menu">
            ...
            <li className="menu-item">
              <a href="index.html">Homepage #2</a>
            </li>
            <li className="menu-item">
              <a href="index.html">Homepage #3</a>
            </li>
          </ul>
        </li>
            ...
            <div className="mega-wrap">
              <div className="mega-column">
                <ul className="mega-item mega-features">
                  ...
                  <li>
                    <a href="product-listing.html">MOTHERS DAY COLLECTION</a>
                    {/* <a href="product-listing.html">MOTHER'S DAY COLLECTION</a> */}
                  </li>
                  <li>
              ...
              <div className="mega-column">
                ...
                <ul className="mega-item">
                  ...
                  <li>
                    <a href="product-listing.html">Hoodies &amp; Sweatshirts</a>
                  </li>
                  <li>
